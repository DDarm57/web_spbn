...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <p class="d-none d-sm-inline-block"><a href="dashboard.php" class="">Dashboard</a> / Data customer</p>
    </div>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="data_customer.php?id_customer=<?= $row["id_customer"]; ?>" class="btn btn-sm btn-danger hapus"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
